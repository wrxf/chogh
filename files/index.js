...
const port = process.env.SERVER_PORT || process.env.PORT || 7300;        
const UUID = process.env.UUID || 'ed1dea74-e729-4d50-9de8-015092f06cff'; //若需要改UUID，需要在config.json里改为一致
...
const ARGO_DOMAIN = process.env.ARGO_DOMAIN || 'cho14.autumnhascome.cf';     // 建议使用token，argo端口8080，cf后台设置需对应,使用json需上传json和yml文件至files目录
const ARGO_AUTH = process.env.ARGO_AUTH || 'eyJhIjoiMjUxNzhjNWNkNTllZWU3MDc4MmU0MDZhZTViMTVmM2QiLCJ0IjoiZGMzMWQ1YWEtN2Y3Yi00ZGU3LWFkNmUtN2FjM2Y1MDcxMmE2IiwicyI6Ik5EVXlZbU14WkdRdFpEZ3hPUzAwWlRBMUxUa3pNamt0WmpGbFlqbG1NekF5TXpRdyJ9';
